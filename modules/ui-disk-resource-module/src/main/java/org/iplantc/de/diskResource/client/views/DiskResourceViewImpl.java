...
public class DiskResourceViewImpl extends Composite implements DiskResourceView, SelectionHandler<Folder>, SelectionChangedHandler<DiskResource>, Taggable {
    ...
    @Inject
    public DiskResourceViewImpl(final Tree<Folder, Folder> tree, final DiskResourceViewToolbar viewToolbar, final DiskResourceAutoBeanFactory factory, final UserInfo userInfo,
    ...
    @Override
    public void setViewLoader(PagingLoader<FolderContentsLoadConfig, PagingLoadResult<DiskResource>> gridLoader) {
